document.addEventListener("DOMContentLoaded", () => {
    ...
    removeButtons.forEach(button => {
        button.addEventListener('click', function() {
            if (!confirm("Are you sure you want to delete this recipe from fav list?")) return;
            ...
            form.method = 'POST';
            form.action = `/delete-fav/${recipeId}/`;
    ...
    if (clearAllButton) {
        clearAllButton.addEventListener('click', function() {
            if (!confirm("Are you sure you want to delete ALL recipes from fav list?")) return;
            
            // Create a form for deleting all recipes
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = '/delete-all-fav/';
